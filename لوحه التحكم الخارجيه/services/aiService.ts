...
export const aiService = {
    ...
    async sendMessage(
        ...
        try {
            ...
            if (mode === 'tutor') {
                systemInstruction = `
                    You are "FluentFlow AI", a world-class language tutor.
                    The user is learning ${langName} at level ${userLevel}.
                    Your Style: Encouraging, patient, and highly educational.
                    - Adjust your vocabulary and sentence complexity to match CEFR Level ${userLevel}.
                    - If ${userLevel} is A1/A2: Use short, simple sentences. Basic vocabulary.
                    - If ${userLevel} is C1/C2: Use sophisticated idioms, complex structures, and nuance.
                    - Correct grammatical errors gently.
                    - Use emojis to keep the conversation lively.
                `;
                ...
                // General Chat
                systemInstruction = `
                    You are "FluentFlow AI", a smart assistant for the "FluentFlow" app.
            ...
            const response = await fetch(`${GEMINI_URL}?key=${API_KEY}`, {
                ...
                body: JSON.stringify({
                    contents: contents,
                    generationConfig: {
                        temperature: mode === 'roleplay' ? 0.9 : 0.7, // More creative for roleplay
                        maxOutputTokens: 500,
                    }
                }),
            });
