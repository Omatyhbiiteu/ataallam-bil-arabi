...
// ============================================================
export const ThemeVisuals: React.FC<ThemeVisualsProps> = ({ theme, isDarkMode, animationsEnabled = true, customConfig, targetLanguage = 'ar' }) => {
    ...
    return (
        <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden" aria-hidden="true" style={{ perspective: 1000 }}>
            ...
            <AnimatePresence mode="wait">
                ...
                {theme === 'ramadan' && <RamadanTheme key="ramadan" isDarkMode={isDarkMode} density={density} visuals={visuals} targetLanguage={targetLanguage} />}
                {theme === 'eid_fitr' && <EidFitrTheme key="eid_fitr" isDarkMode={isDarkMode} targetLanguage={targetLanguage} />}
                {theme === 'eid_adha' && <EidAdhaTheme key="eid_adha" isDarkMode={isDarkMode} targetLanguage={targetLanguage} />}
                ...
                {theme === 'victory_october' && <VictoryOctoberTheme key="victory_october" isDarkMode={isDarkMode} targetLanguage={targetLanguage} />}
                {theme === 'custom' && (
                    <CustomTheme
                        key="custom"
